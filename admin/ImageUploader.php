...
//        $urlSimplified = preg_split('/^(www(2|3)?\.)/i', $url, -1, PREG_SPLIT_NO_EMPTY); // Delete www from URL
    ...
    public function validate()
    {
        ...
        if ($urls = Automatic_Upload_Images_Admin::getOption('exclude_urls')) {
    ...
    {
        $filename = trim($this->resolvePattern(Automatic_Upload_Images_Admin::getOption('image_name', '%filename%')));
    ...
    {
        return $this->resolvePattern(Automatic_Upload_Images_Admin::getOption('alt_name'));
    }
    ...
    {
        $width = Automatic_Upload_Images_Admin::getOption('max_width');
        $height = Automatic_Upload_Images_Admin::getOption('max_height');
    ...
    {
        return Automatic_Upload_Images_Admin::getOption('max_width') || Automatic_Upload_Images_Admin::getOption('max_height');
    }
